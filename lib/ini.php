<?
  ...
  define ("SOFTWAREVERSION", "1.19.10");
  ...
  define ("CATALOGUE_REGEX", "/\,( )*(bwv|wwv|hwv|op|opus|d|k|kv|hess|woo|fs|k\.anh|wq|w|sz|kk|m|s|h|trv|rv|jb ([0-9]+\:)|jw ([a-z]+\/)|(hob\.([a-z])+\:))( |\.)*(([0-9]+)([a-z])?)/i");
